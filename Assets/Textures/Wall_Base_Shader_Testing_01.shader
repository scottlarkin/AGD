...
////// Specular:
                ...
                float node_4345 = 0.3;
                float3 specularColor = float3(node_4345,node_4345,node_4345);
...
/////// Diffuse:
                ...
                float3 diffuse = (directDiffuse + indirectDiffuse) * float3(0.9852941,0.7911332,0.4998919);
/// Final Color:
...
/////// Diffuse:
                NdotL = max(0.0,dot( normalDirection, lightDirection ));
                float3 directDiffuse = max( 0.0, NdotL) * attenColor;
                float3 diffuse = directDiffuse * float3(0.9852941,0.7911332,0.4998919);
/// Final Color:
                float3 finalColor = diffuse + specular;
