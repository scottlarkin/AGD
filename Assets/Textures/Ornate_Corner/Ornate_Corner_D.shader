...
/////// Diffuse:
                ...
                float4 _node_766_var = tex2D(_node_766,TRANSFORM_TEX(i.uv0, _node_766));
                float3 diffuse = (directDiffuse + indirectDiffuse) * _node_766_var.rgb;
/// Final Color:
...
/////// Diffuse:
                ...
                float3 directDiffuse = max( 0.0, NdotL) * attenColor;
                float4 _node_766_var = tex2D(_node_766,TRANSFORM_TEX(i.uv0, _node_766));
                float3 diffuse = directDiffuse * _node_766_var.rgb;
/// Final Color:
                float3 finalColor = diffuse;
