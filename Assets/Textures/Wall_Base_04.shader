...
////// Specular:
                ...
                float node_4955 = 0.3;
                float3 specularColor = float3(node_4955,node_4955,node_4955);
...
/////// Diffuse:
                ...
                float3 diffuse = (directDiffuse + indirectDiffuse) * float3(0.9558824,0.3162846,0.4089159);
/// Final Color:
...
/////// Diffuse:
                NdotL = max(0.0,dot( normalDirection, lightDirection ));
                float3 directDiffuse = max( 0.0, NdotL) * attenColor;
                float3 diffuse = directDiffuse * float3(0.9558824,0.3162846,0.4089159);
/// Final Color:
                float3 finalColor = diffuse + specular;
