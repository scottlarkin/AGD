...
////// Specular:
                ...
                float node_8122 = 0.3;
                float3 specularColor = float3(node_8122,node_8122,node_8122);
...
/////// Diffuse:
                ...
                float3 diffuse = (directDiffuse + indirectDiffuse) * float3(0.8297869,0.8308824,0.824773);
/// Final Color:
...
/////// Diffuse:
                NdotL = max(0.0,dot( normalDirection, lightDirection ));
                float3 directDiffuse = max( 0.0, NdotL) * attenColor;
                float3 diffuse = directDiffuse * float3(0.8297869,0.8308824,0.824773);
/// Final Color:
                float3 finalColor = diffuse + specular;
