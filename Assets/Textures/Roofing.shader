...
Shader "Shader Forge/Roofing" {
    ...
    SubShader {
        ...
        Pass {
            ...
            uniform sampler2D _node_8220; uniform float4 _node_8220_ST;
            struct VertexInput {
...
/////// Diffuse:
                ...
                float4 _node_8220_var = tex2D(_node_8220,TRANSFORM_TEX(i.uv0, _node_8220));
                float3 diffuse = (directDiffuse + indirectDiffuse) * (_node_8220_var.rgb*1.2);
/// Final Color:
...
/////// Diffuse:
                ...
                float3 directDiffuse = max( 0.0, NdotL) * attenColor;
                float4 _node_8220_var = tex2D(_node_8220,TRANSFORM_TEX(i.uv0, _node_8220));
                float3 diffuse = directDiffuse * (_node_8220_var.rgb*1.2);
/// Final Color:
                float3 finalColor = diffuse;
