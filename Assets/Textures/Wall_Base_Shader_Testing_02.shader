...
////// Specular:
                ...
                float node_9449 = 0.3;
                float3 specularColor = float3(node_9449,node_9449,node_9449);
...
/////// Diffuse:
                ...
                float3 diffuse = (directDiffuse + indirectDiffuse) * float3(0.9852941,0.5991707,0.4854022);
/// Final Color:
...
/////// Diffuse:
                NdotL = max(0.0,dot( normalDirection, lightDirection ));
                float3 directDiffuse = max( 0.0, NdotL) * attenColor;
                float3 diffuse = directDiffuse * float3(0.9852941,0.5991707,0.4854022);
/// Final Color:
                float3 finalColor = diffuse + specular;
