...
public class PlatformCollision : MonoBehaviour
{
	...
	//Takes the current Mesh and checks which triangles have normals pointed at which angle.
	// A 45 angle allows for only triangles facing upwards. Any which have a higher angle are removed
	// A new mesh is then created on the object.
	void Start ()
	{
